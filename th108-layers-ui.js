      ...
      if(L.type==='background'){
        ...
        let html='<div class="ctl">'+
          ...
          (s.source==='mic' ? sub('Mic Input')+
            row('Mic Gain','<span class="srange" style="width:100%"><input type="range" class="s-micGain" min="50" max="3600" step="10" value="'+(s.micGain==null?100:s.micGain)+'" title="SENSITIVITY — how little input drives the bars to full. Higher = less voice/volume needed to fill the board (turn it up if it takes too much input). Lower = needs a louder input."><i class="tick" style="left:calc(7px + (100% - 14px)*0.0141)"></i></span><span class="val s-micGainV"></span>')+
