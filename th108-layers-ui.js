    ...
    function buildLayerBody(card,L){
      ...
      if(L.type==='background'){
        ...
        body.innerHTML='<div class="ctl">'+
          ...
          full('<input type="file" class="s-mediaFile" accept="image/*" style="flex:none"><button type="button" class="s-mediaClear" style="flex:none" title="Offload the loaded GIF/image from this layer">Release</button>')+
