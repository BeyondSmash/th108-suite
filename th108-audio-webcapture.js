...
(function (root) {
  ...
  function createWebCapture(log) {
    ...
    async function start(sourceKind) {
      ...
      } catch (e) { log(TH108i18n.tfLog('audio capture cancelled / denied: {0}', (e && e.message || e)), 'dim'); return false; }
      ...
      log(TH108i18n.tfLog('in-tab audio capture started ({0})', sourceKind), 'ok');
      return true;
    }
